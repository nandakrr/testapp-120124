  ...
  function __construct()
  {
	...
	//	$campaign = $request->get('campaign');
		...
		if ($ad_keyword == 'mobile') {
			$headline='In-home Spa-Quality Mobile Massage';
		} elseif ($ad_keyword == 'sameday') {
			$headline='In-home Spa-Quality Same Day Massage';
		} elseif ($ad_keyword == 'hotel') {
			$headline='Spa-Quality In-Room Massage Delivered to Your Hotel';
		} elseif ($ad_keyword == 'specifictype') {
			$keyword=$request->get('keyword');	
			if ($keyword) {
				$headline='In-home Spa-Quality '.ucwords($keyword);				
			} else {
		...
		//	$city='';
			if ($city) {
				if ($city == 'Southern California' || $city == 'Bay Area' || $city == 'Greater New York') {
					$headline=$headline.' in '.$city.' for $99.99';					
				} else {
					$headline=$headline.' in '.$city.' for $99.99';
				}
				$subheadline='Get an awesome, licensed massage therapist to come to your home or hotel at a fraction of spa price. Available as early as same day. In all major metros, including '.$campaign_data->nearby.' and nearby areas.';
			} else {
				$headline=$headline.' for $99.99';
				$subheadline='Get an awesome, licensed massage therapist to come to your home or hotel at a fraction of spa price. Available as early as same day.';
			}				
		} else {
			
			if ($ad_keyword == 'specifictype') {
				$subheadline='Book in Seconds! Get an awesome, licensed massage therapist to come to your home or hotel at a fraction of spa price. Available as early as same day.';				
			} else {
				$subheadline='Get an awesome, licensed massage therapist to come to your home or hotel at a fraction of spa price. Available as early as same day.';
			...
			if (!($ad_keyword == 'specifictype' && ($keyword == 'lymphatic massage' || $keyword == 'prenatal massage' || $keyword == 'couples massage'))) {
				$headline=$headline.' for $99.99';
			}
		...
		return view('landing-page-massage', ['headline' => $headline, 'subheadline' => $subheadline, 'ad_keyword' => $ad_keyword]);
	...
	public function landingmassage2(Request $request) {
		...
		return view('landing-page-massage2', ['headline' => $headline]);
	}
